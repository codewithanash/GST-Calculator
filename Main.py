...
if __name__ == "__main__":
    music_file = "Sia_-_Cheap_Thrills_acoustic_instrumental_version_piano_cimbaly_dulcimer__cover__Come_on_Come_on.._(256k).mp3"
...
class Bill_App:
    def __init__(self,root):
        ...
        tax_snacks=Label(billing_menu,text="GST on Snacks",font=("Arial Black",11),bg="#A569BD",fg="white").grid(row=0,column=2)
        tax_snacks_entry=Entry(billing_menu,width=30,borderwidth=2,textvariable=self.a).grid(row=0,column=3,padx=10,pady=7)

        tax_grocery=Label(billing_menu,text="GST on Grocery",font=("Arial Black",11),bg="#A569BD",fg="white").grid(row=1,column=2)
        tax_grocery_entry=Entry(billing_menu,width=30,borderwidth=2,textvariable=self.b).grid(row=1,column=3,padx=10,pady=7)


        tax_hygine=Label(billing_menu,text="GST on Beauty & Hygine",font=("Arial Black",11),bg="#A569BD",fg="white").grid(row=2,column=2)
        ...
        button_frame.place(x=880,width=450,height=105)
